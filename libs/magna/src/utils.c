 ...
 * только 64 символов ASCII. Алфавит кодирования содержит
 * текстово-цифровые латинские символы A-Z, a-z и 0-9 (62 знака)
 * и 2 дополнительных символа, зависящих от системы реализации.
 * Каждые 3 исходных байта кодируются 4 символами (увеличение на ¹⁄₃).
 *
 * Эта система широко используется в электронной почте для
 * представления бинарных файлов в тексте письма (транспортное
 * кодирование).
 *
 * В примере, слово Man закодировано как TWFu. Процесс преобразования
...
/**
 * Получение псевдослучайного числа методом
...
/**
 * Установка затравки для линейного конгруэнтного метода
