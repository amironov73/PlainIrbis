...
static am_wchar _cp1251_to_unicode[256] = {
...
static am_wchar _cp1251_from_unicode[256] = {
    0x0000, 0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006, 0x0007, 0x0008, 0x0009, 0x000A, 0x000B, 0x000C, 0x000D, 0x000E, 0x000F,
    0x0010, 0x0011, 0x0012, 0x0013, 0x0014, 0x0015, 0x0016, 0x0017, 0x0018, 0x0019, 0x001A, 0x001B, 0x001C, 0x001D, 0x001E, 0x001F,
    0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, 0x0028, 0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x002E, 0x002F,
    0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, 0x0038, 0x0039, 0x003A, 0x003B, 0x003C, 0x003D, 0x003E, 0x003F,
...
static am_byte _cp1251_xlat[256] = {
 ...
 */
MAGNA_API unsigned MAGNA_CALL cp1251_char_to_unicode
    (
        am_byte chr
    )
{
 ...
 * @return Узкий символ.
 */
MAGNA_API am_byte MAGNA_CALL cp1251_unicode_to_char
    (
        unsigned uchr
    )
{
    am_ssize_t found = search_for_unicode (_cp1251_from_unicode, 0, 255, (am_wchar) uchr);

    return found < 0 ? '?' : _cp1251_xlat [found];
}
 ...
 * @return
 */
MAGNA_API am_bool MAGNA_CALL cp1251_char_to_utf8
    (
        Buffer *buffer,
        am_byte chr
    )
 ...
 * @return
 */
MAGNA_API am_bool MAGNA_CALL cp1251_buffer_to_utf8
    (
        Buffer *target,
        const Buffer *source
    )
 ...
 * @return
 */
MAGNA_API am_bool MAGNA_CALL cp1251_buffer_from_utf8
    (
        Buffer *target,
        const Buffer *source
    )
